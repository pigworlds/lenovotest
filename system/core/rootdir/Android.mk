...
# chenyushun add resource in line 146 for add resource partition
LOCAL_POST_INSTALL_CMD := mkdir -p $(addprefix $(TARGET_ROOT_OUT)/, \
    sbin dev proc sys system data oem resource acct config storage mnt root $(BOARD_ROOT_EXTRA_FOLDERS)); \
